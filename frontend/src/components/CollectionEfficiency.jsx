  ...
  if (loading) {
    return (
      <div className="text-center py-12">
        ...
        <p className="mt-4 text-sm text-[var(--color-text-muted)]">Analyzing efficiency...</p>
      </div>
    )
  }
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-[var(--color-text-muted)]">Card Utilization</span>
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-[var(--color-text-muted)]">Unique Cards</span>
          ...
          <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-xs text-[var(--color-text-muted)]">Unused Value</span>
                    ...
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-[var(--color-border)] bg-[var(--color-surface)]">
                          <th className="text-left px-4 py-2.5 text-[var(--color-text-muted)] text-xs uppercase tracking-wider font-semibold">
                            <SortHeader label="Card" sortKey="name" currentSort={unusedSort} onSort={handleUnusedSort} />
                          </th>
                          <th className="text-center px-4 py-2.5 text-[var(--color-text-muted)] text-xs uppercase tracking-wider font-semibold">
                          ...
                          <th className="text-right px-4 py-2.5 text-[var(--color-text-muted)] text-xs uppercase tracking-wider font-semibold">
